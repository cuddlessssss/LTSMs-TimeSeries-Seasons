...
# 4. Calculate trend + seasonality using Huber regression with month dummies
trend_preds = {}
...
wb.save('forecast_output_trend_seasonality_huber.xlsx')
