...
data = pd.read_excel('your_past_data.xlsx', sheet_name='mdr_audio_gaming_ph')
data.columns = data.columns.str.strip()
# 🎯 Allow one or more categories
allowed_categories = ['PRO AUDIO','MDR & PORTABLE DEVICE']  # You can add more like ['PRO AUDIO', 'LCD TV']
...
wb.save('forecast_output_trend_seasonality_testing_actuals_2cat.xlsx')
